...
fn update_square_position(square: &web_sys::Element, x: f32, y: f32) {
  let style = format!("background: #4c34b2; width: {}px; height: {}px; transform: translate({}px, {}px);", BOX_SIZE, BOX_SIZE, x, y as f32); // the added space is for the box to be position at its epicenter
